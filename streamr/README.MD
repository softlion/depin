...
* you must manually update the config file with the [instructions there](https://docs.streamr.network/guides/become-an-operator/). I may eventually update my script to do that automatically.
